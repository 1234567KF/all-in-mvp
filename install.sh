...
install_to_agent() {
    ...
    if [ "$USE_LOCAL" = true ] && [ -d "$SCRIPT_DIR/skills" ]; then
        ...
        if command_exists npx; then
            ...
            npx giget "gh:1234567KF/all-in-mvp#all-in-mvp/skills" "$target_dir" --force --ignore "AGENTS.md,README.md,INSTALL.md,WhyMe.md,MVP*,screenshot-1-full.png,nul,all-in-mvp-*.md,shadcn/**,tools/**,overlays/**,ultra-cost-effective/**"
        ...
        if [ -d "$SCRIPT_DIR/skills" ]; then
            ...
            print_info "请先运行: npx giget gh:1234567KF/all-in-mvp#all-in-mvp --ignore \"AGENTS.md,README.md,INSTALL.md,WhyMe.md,MVP*,screenshot-1-full.png,nul,all-in-mvp-*.md,shadcn/**,tools/**,overlays/**,ultra-cost-effective/**\""
            return 1
        fi
    fi
}
...
install_all() {
    ...
    echo "  npx giget gh:1234567KF/all-in-mvp#all-in-mvp my-new-project --ignore \"AGENTS.md,README.md,INSTALL.md,WhyMe.md,MVP*,screenshot-1-full.png,nul,all-in-mvp-*.md,shadcn/**,tools/**,overlays/**,ultra-cost-effective/**\""
...
show_help() {
    ...
    echo "  npx giget gh:1234567KF/all-in-mvp#all-in-mvp my-project --ignore \"AGENTS.md,README.md,INSTALL.md,WhyMe.md,MVP*,screenshot-1-full.png,nul,all-in-mvp-*.md,shadcn/**,tools/**,overlays/**,ultra-cost-effective/**\""
